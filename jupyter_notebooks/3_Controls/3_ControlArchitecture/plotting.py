...
def plot_timeseries(data, t, cor, lst='-'):
    plt.plot(t, data, color=cor, linestyle=lst)
    plt.show()
    
def plot_z(history, z_path, t):
    plt.plot(t, z_path, color='red', linestyle='-.', linewidth=3)
    plt.plot(t, history[:,0], color='blue', linestyle='-')
    plt.show()
    
def plot_y(history, y_path, t):
    plt.plot(t, y_path, color='red', linestyle='-.', linewidth=3)
    plt.plot(t, history[:,1], color='blue', linestyle='-')
    plt.show()
